...
namespace Repomat.CodeGen
{
    internal class PrimitiveTypeInfo
    {
        ...
        static PrimitiveTypeInfo()
        {
            ...
            CreateType(typeof(short?), "reader.IsDBNull({0}) ? null : (short?)reader.GetInt16({0})", "({0} == null || {0} == System.DBNull.Value) ? null : (short?)System.Convert.ToInt16({0})", "SMALLINT", NullableConversion<int>("ToInt16"));
            CreateType(typeof(long?), "reader.IsDBNull({0}) ? null : (long?)reader.GetInt64({0})", "({0} == null || {0} == System.DBNull.Value) ? null : (long?)System.Convert.ToInt64({0})", "BIGINT", NullableConversion<int>("ToInt64"));
            CreateType(typeof(byte?), "reader.IsDBNull({0}) ? null : (byte?)reader.GetByte({0})", "({0} == null || {0} == System.DBNull.Value) ? null : (byte?)System.Convert.ToByte({0})", "TINYINT", NullableConversion<int>("ToByte"));
            CreateType(typeof(bool?), "reader.IsDBNull({0}) ? null : (bool?)reader.GetBoolean({0})", "({0} == null || {0} == System.DBNull.Value) ? null : (bool?)System.Convert.ToBoolean({0})", "BIT", NullableConversion<int>("ToBoolean"));
            CreateType(typeof(decimal?), "reader.IsDBNull({0}) ? null : (decimal?)reader.GetDecimal({0})", "({0} == null || {0} == System.DBNull.Value) ? null : (decimal?)System.Convert.ToDecimal({0})", "MONEY", NullableConversion<int>("ToDecimal"));
            CreateType(typeof(DateTime?), "reader.IsDBNull({0}) ? null : (DateTime?)reader.GetDateTime({0})", "({0} == null || {0} == System.DBNull.Value) ? null : (DateTime?)System.Convert.ToDateTime({0})", "DATETIME", NullableConversion<int>("ToDateTime"));
            ...
            CreateType(typeof(uint?), "reader.IsDBNull({0}) ? null : (uint?)reader.GetInt32({0})", "({0} == null || {0} == System.DBNull.Value) ? null : (uint?)System.Convert.ToUInt32({0})", "INT", NullableConversion<int>("ToUInt32"));
            CreateType(typeof(ushort?), "reader.IsDBNull({0}) ? null : (ushort?)reader.GetInt16({0})", "({0} == null || {0} == System.DBNull.Value) ? null : (ushort?)System.Convert.ToUInt16({0})", "SMALLINT", NullableConversion<int>("ToInt16"));
            CreateType(typeof(ulong?), "reader.IsDBNull({0}) ? null : (ulong?)reader.GetInt64({0})", "({0} == null || {0} == System.DBNull.Value) ? null : (ulong?)System.Convert.ToUInt64({0})", "BIGINT", NullableConversion<int>("ToInt64"));
